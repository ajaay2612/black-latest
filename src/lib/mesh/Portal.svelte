<script>
    ...
    const handlePointerMove = (e) => {
        ...
        if (e.uv && meshRef?.material?.uniforms) {
            console.log('UV coordinates:', e.uv.x, e.uv.y);
            
            // Direct uniform update
            meshRef.material.uniforms.pos.value[0] = e.uv.x;
            meshRef.material.uniforms.pos.value[1] = e.uv.y;
            meshRef.material.uniforms.pos.needsUpdate = true;
    ...
    const handlePointerEnter = (e) => {
        ...
        if (meshRef?.material?.uniforms) {
            // Direct uniform update
            meshRef.material.uniforms.uEmissionStrength.value = 6;
            meshRef.material.uniforms.uEmissionStrength.needsUpdate = true;
        }
    ...
    const handlePointerLeave = (e) => {
        ...
        if (meshRef?.material?.uniforms) {
            // Direct uniform update
            meshRef.material.uniforms.pos.value[0] = 0.5;
            meshRef.material.uniforms.pos.value[1] = 0.5;
            meshRef.material.uniforms.pos.needsUpdate = true;
            meshRef.material.uniforms.uEmissionStrength.value = 4;
            meshRef.material.uniforms.uEmissionStrength.needsUpdate = true;
        }
